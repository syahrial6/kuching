...
import { Home, Info, Map, Image as ImageIcon, Mail, ArrowRight, ShieldCheck } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-12">
          ...
          <div className="lg:col-span-12 xl:col-span-5 space-y-8">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xl">
              Layanan transportasi lintas negara premium yang menghubungkan Kalimantan Barat dan Malaysia. 
              Mengedepankan keamanan dan kenyamanan eksklusif untuk setiap perjalanan Anda.
            </p>

            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-2xl bg-white/[0.03] border border-white/5">
               <ShieldCheck size={16} className="text-cyan-500" />
               <span className="text-[11px] text-gray-400 font-medium uppercase tracking-wider">Official & Licensed Transport</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-8 xl:col-span-4">
            ...
            <div className="grid sm:grid-cols-2 xl:grid-cols-1 gap-3">
              {/* WhatsApp Cards */}
              {[
                { label: "Booking Admin 1", link: "https://wa.me/62895321866545" },
                { label: "Booking Admin 2", link: "https://wa.me/6285822593523" }
              ].map((admin, idx) => (
                <a
                  key={idx}
                  href={admin.link}
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-white font-bold text-[11px] uppercase tracking-wide">{admin.label}</p>
                      <p className="text-gray-500 text-[10px] mt-0.5">Tersedia • Klik untuk chat</p>
                    </div>
                  </div>
                  <ArrowRight size={14} className="text-gray-700 group-hover:text-white group-hover:translate-x-1 transition-all" />
                </a>
              ))}

              {/* Socials Small */}
              <div className="flex gap-2">
                <a href="mailto:argroup.ptk@gmail.com" className="flex-1 py-3 rounded-xl bg-white/5 border border-white/10 flex justify-center text-gray-400 hover:text-red-400 transition-colors">
                  <Mail size={18} />
                </a>
                <a href="https://instagram.com/argroup.ptk" className="flex-1 py-3 rounded-xl bg-white/5 border border-white/10 flex justify-center text-gray-400 hover:text-pink-400 transition-colors">
                  <FaInstagram size={18} />
                </a>
                <a href="#" className="flex-1 py-3 rounded-xl bg-white/5 border border-white/10 flex justify-center text-gray-400 hover:text-white transition-colors">
                  <FaTiktok size={18} />
                </a>
              </div>
            </div>
