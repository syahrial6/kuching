  ...
  return (
    <footer className="pt-20 pb-10 mt-24 bg-[#08080b] border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-3 gap-14">
          ...
          <div>
            ...
            <div className="flex items-start gap-3 text-gray-300 text-sm relative">
              <MessageCircle size={20} className="text-green-400 mt-1" />
          ...
          bg-white/10 backdrop-blur-xl text-white text-xs px-3 py-1
          rounded-lg border border-white/20 shadow-lg whitespace-nowrap
        "
                  >
                    Admin 1
                  </span>
        ...
        {/* Divider */}
        <div className="h-px w-full bg-white/5 mt-16"></div>
